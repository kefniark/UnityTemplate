...
namespace Utils.EventManager.Extensions
{
	public static class GameObjectExtension
	{
		...
		{
			return GetOrAddComponent<SubscriberGameObject>(behaviour.gameObject).Subscriber;
		}
		...
		public static Coroutine WaitForMessage(this MonoBehaviour behaviour, string[] topics, float timeout = 0.0f)
		{
			...
			return behaviour.StartCoroutine(Tools.Coroutine.WaitForMessage(subscriberObject.Subscriber, topics, timeout));
		}
